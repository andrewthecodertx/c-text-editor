...
char *C_HL_types[] = {"int",  "char", "float", "double",
                      "void", "long", "short", NULL};
...
char *JS_HL_keywords[] = {
    ...
    "throw",      "new",    "this",    "super",  "class",    "extends",
    "import",     "export", "await",   "async",  "yield",    "typeof",
    "instanceof", "delete", "in",      "void",   "debugger", "with",
    NULL};
...
char *XML_HL_keywords[] = {"xml",     "version",   "encoding", "root",
...
EditorSyntax *EditorSyntaxes[] = {&C_syntax,    &SH_syntax,  &JS_syntax,
                                  &HTML_syntax, &CSS_syntax, &XML_syntax,
                                  NULL};
...
void editor_update_syntax(int filerow) {
  ...
  int in_multiline_comment =
      (filerow > 0 && E->lines.elements[filerow - 1].hl_open_comment);
